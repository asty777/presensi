...
const ProfilePage = () => {
  ...
  const fetchCompanyData = async () => {
    try {
      ...
      const response = await axios.get('http://192.168.10.103:8008/company/profile', {
        headers: {
      ...
      <Layout>
        <div className="p-4 sm:ml-64">
          <div className="p-4 rounded-lg dark:border-gray-700 mt-14">
            ...
            {location.state && location.state.EditProfileMessage && (
               <div className="p-4 mb-4 mt-3 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800" role="alert">
                  {location.state.EditProfileMessage}
                </div>
             )}
            ...
            <div className="w-xl mt-8 p-6 bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="flex justify-end gap-2">
                ...
                <button className='bg-[#fef5ea] rounded-full border border-[#e0a3cf] w-[130px] font-medium text-xs  py-3'>
                    Update
                  </button>
                </Link>
              </div>
